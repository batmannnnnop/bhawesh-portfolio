...
export default function Footer() {
  ...
  return (
    <footer className="border-t px-6 py-8" style={{ borderColor: '#DDD8CE' }}>
      <div className="max-w-5xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
        <div>
          <p className="font-bold text-base" style={{ fontFamily: "'Syne', sans-serif", color: '#1A1814' }}>
            Bhawesh Chandnani<span style={{ color: '#E8572A' }}>.</span>
          </p>
          <p className="text-xs mt-0.5" style={{ fontFamily: "'JetBrains Mono', monospace", color: '#8C8880' }}>
            Learning in public · {year}
          </p>
        </div>
        ...
        <a href="#hero" className="text-xs transition-colors" style={{ fontFamily: "'JetBrains Mono', monospace", color: '#8C8880' }}
          onMouseEnter={e => e.currentTarget.style.color = '#E8572A'}
          onMouseLeave={e => e.currentTarget.style.color = '#8C8880'}>
          ↑ Back to top
        </a>
